<template>
    <section class="admin-entity-wrapper">
        <md-toolbar class="md-primary">
            <h3 class="md-title">Подкатегории</h3>
        </md-toolbar>
        <md-table v-model="searched.data" md-card @md-selected="onSelect" md-sort="position" md-sort-order="asc">
            <md-table-toolbar>
                ...
                <md-button :href="'/admin/subcategory/create'" class="md-fab md-mini">
                    <md-icon>add</md-icon>
                </md-button>
            </md-table-toolbar>
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }" md-selectable="multiple" md-auto-select>
                ...
                <md-table-cell md-label="Опции" md-sort-by="title">
                    <div class="option-container">
                        <a class="copy" :href="'/admin/subcategory/copy/'+item.id">
                            <md-icon>content_copy</md-icon>
                        </a>
                        <a class="edit" :href="'/admin/subcategory/edit/'+item.id">
