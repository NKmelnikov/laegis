    ...
    <section class="admin-entity-wrapper">
        ...
        <md-table v-model="searched.data" md-card @md-selected="onSelect" md-sort="position" md-sort-order="asc">
            <md-table-toolbar>
                ...
                <md-button :href="'/admin/product/create'" class="md-fab md-mini">
                    <md-icon>add</md-icon>
                </md-button>
            </md-table-toolbar>
            ...
            <md-table-row slot="md-table-row" slot-scope="{ item }" md-selectable="multiple" md-auto-select>
                ...
                <md-table-cell md-label="Окончание url" md-sort-by="name">{{ item.slug }}</md-table-cell>
                <md-table-cell md-label="Бренд" md-sort-by="brand_name">{{ item.brand_name }}</md-table-cell>
                <md-table-cell md-label="Категория" md-sort-by="category_name">{{ item.category_name }}</md-table-cell>
                <md-table-cell md-label="Подкатегория" md-sort-by="subcategory_name">{{ item.subcategory_name }}</md-table-cell>
                ...
                <md-table-cell md-label="Опции" md-sort-by="title">
                    <div class="option-container">
                        <a class="copy" :href="'/admin/product/copy/'+item.slug">
                            <md-icon>content_copy</md-icon>
                        </a>
                        <a class="edit" :href="'/admin/product/edit/'+item.slug">
