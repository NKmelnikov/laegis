<template>
    <section class="admin-entity-wrapper">
        <md-toolbar class="md-primary">
            <h3 class="md-title">
                {{ actionTranslater(entity.action) }} новость</h3>
        </md-toolbar>
            ...
            <md-tab style="overflow: visible" id="tab-home" md-label="Общее">
                <div class="admin-form entity-create-form">
                    ...
                    <md-field>
                        ...
                        <md-textarea v-model="entity.shortText"></md-textarea>
                    </md-field>

                    <label>Текст новости</label>
                    <froala v-if="!frolaLoading" :tag="'textarea'" :config="frolaConfig" v-model="entity.article"></froala>
...
<!--            english tab-->
            <md-tab id="tab-pages" md-label="English">
                <div class="admin-form">
                    ...
                    <md-field>
                        <label>Краткое описание</label>
                        <md-textarea v-model="entity.shortText_en"></md-textarea>
                    </md-field>
                    <label>Текст новости</label>
                    <froala :tag="'textarea'" :config="frolaConfig" v-model="entity.article_en"></froala>
                </div>
            </md-tab>
